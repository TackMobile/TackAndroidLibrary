...
package com.tack.android.image;
...
import com.tack.android.BuildConfig;
import com.tack.android.util.ConfigUtil;
import com.tack.android.util.DiskLruCache;
...
public class ImageCache {
  ...
  private static final boolean DEFAULT_USE_DB_DISK_CACHE = false;
  ...
  public void addBitmapToCache(String data, Bitmap bitmap) {
      ...
      if (mCacheParams.useDBDiskCache) {
   ...
   *
   * @param data Unique identifier for which item to get
   * @param resolver Used to access the db cache (can be null)
   * @return The bitmap if found in cache, null otherwise
   */
  public Bitmap getBitmapFromDiskCache(String data, ContentResolver resolver) {
    final String key = hashKeyForDisk(data);

    if (mCacheParams.useDBDiskCache) {
      if (resolver == null) return null;
      
      Uri bitmapUri = mCacheParams.baseCacheUri.buildUpon().appendEncodedPath(key).build();
      InputStream inputStream = null;
      try {
        inputStream = resolver.openInputStream(bitmapUri);
        if (inputStream != null) {
  ...
  public static class ImageCacheParams {
      ...
      public boolean useDBDiskCache = DEFAULT_USE_DB_DISK_CACHE;
      private Uri baseCacheUri;
      ...
      public ImageCacheParams(Uri baseCacheUri) {
        useDBDiskCache = true;
        this.initDiskCacheOnCreate = false;
        this.baseCacheUri = baseCacheUri; 
      }
